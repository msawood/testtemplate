...
// configuration step. It creates a namespace called `testtemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", testtemplate::cmake::project_name, testtemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", testtemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
